...
export const HFAT2Rows = (data) =>
  data.map((row) => ({
    ...
    table1_16_Manpower: row.table1?.[16]?.length > 0 ? "other" : "",
    ...
    H2C3_10: row.H2C3?.[10],
    H2C3_11: row.H2C3?.[11],
    H2C3_12: row.H2C3?.[12]?.length > 0 ? "other" : "",
    H2C3_13: row.H2C3?.[12],
    ...
    H2G4_0: row.H2G4?.[0],
    H2G4_1: row.H2G4?.[1],
    H2G4_2: row.H2G4?.[2]?.length > 0 ? "other" : "",
    H2G4_3: row.H2G4?.[2],
    H2G5: row.H2G5,
    H2G6: row.H2G6,
    H2H1: row.H2H1,
    ...
    H2H8_0: row.H2H8?.[0],
    H2H8_1: row.H2H8?.[1],
    H2H8_2: row.H2H8?.[2]?.length > 0 ? "other" : "",
    H2H8_3: row.H2H8?.[2],
    H2H9: row.H2H9,
    H2I1_0: row.H2I1?.[0],
    H2I1_1: row.H2I1?.[1],
    ...
    H2I1_6: row.H2I1?.[6],
    H2I1_7: row.H2I1?.[7],
    H2I1_8: row.H2I1?.[8]?.length > 0 ? "other" : "",
    H2I1_9: row.H2I1?.[8],
    H2I2_0: row.H2I2?.[0],
    H2I2_1: row.H2I2?.[1],
    H2I2_2: row.H2I2?.[2],
