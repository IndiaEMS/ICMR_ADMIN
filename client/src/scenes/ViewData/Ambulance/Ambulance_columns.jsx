...
export const columns = [
  ...
  },
  {
    ...
    children: [
      {
        field: "AMB13",
        headerName: "Portable or Mounted Suction Machine",
        valueFormatter: (params) =>
      ...
      {
        field: "AMB13",
        headerName: "Flexible suction catheters Fr. 5,8,12 and 14",
        valueFormatter: (params) => {
          console.log(params);
...

  {
    ...
    children: [
      {
        field: "AMB14",
        headerName: "Portable oxygen tank with regulator",
        valueFormatter: (params) =>
