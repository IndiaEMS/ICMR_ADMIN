...
export const HFAT3Rows = (data) =>
  data.map((row) => ({
    ...
    H3B8_4: row.H3B8?.[4],
    H3B8_5: row.H3B8?.[5],
    H3B8_6: row.H3B8?.[6] != null || row.H3B8?.[6] != "" ? "other" : "",
    H3B8_7: row.H3B8?.[6],
    H3B9: row.H3B9,
    H3B10: row.H3B10,
    ...
    table1_11_Manpower:
      row.table1?.[11]?.Manpower != null || row.table1?.[11]?.Manpower != ""
        ? "other"
        : "",
    ...
    H3C3_10: row.H3C3?.[10],
    H3C3_11: row.H3C3?.[11],
    H3C3_12: row.H3C3?.[12] != null || row.H3C3?.[12] != "" ? "other" : "",
    H3C3_13: row.H3C3?.[12],
    ...
    H3G4_0: row.H3G4?.[0],
    H3G4_1: row.H3G4?.[1],
    H3G4_2: row.H3G4?.[2] != null || row.H3G4?.[2] != "" ? "other" : "",
    H3G4_3: row.H3G4?.[2],
    H3G5: row.H3G5,
    H3G6: row.H3G6,
    H3H1: row.H3H1,
    ...
    H3H8_0: row.H3H8?.[0],
    H3H8_1: row.H3H8?.[1],
    H3H8_2: row.H3H8?.[2] != null || row.H3H8?.[2] != "" ? "other" : "",
    H3H8_3: row.H3H8?.[2],
    H3H9: row.H3H9,
    H3I1_0: row.H3I1?.[0],
    H3I1_1: row.H3I1?.[1],
    ...
    H3I1_6: row.H3I1?.[6],
    H3I1_7: row.H3I1?.[7],
    H3I1_8: row.H3I1?.[8] != null || row.H3I1?.[8] != "" ? "other" : "",
    H3I1_9: row.H3I1?.[8],
    H3I2_0: row.H3I2?.[0],
    H3I2_1: row.H3I2?.[1],
    H3I2_2: row.H3I2?.[2],
