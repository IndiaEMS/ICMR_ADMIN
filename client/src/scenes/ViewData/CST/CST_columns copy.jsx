...
// const generateEmergencyColumns = (data, maxMembers) => {
//   return Array.from({ length: maxMembers }, (_, index) => {
//     const columns = [
//       { field: `Name`, headerName: "Name" },
//       { field: `Age`, headerName: "Age" },
...
const generateBColumns = (data, maxMembers) => {
  return Array.from({ length: maxMembers }, (_, index) => {
    const columns = [
      {
        field: "B0",
...
const generateCColumns = (data, maxMembers) => {
  return Array.from({ length: maxMembers }, (_, index) => {
    const columns = [
      {
        field: "C1",
      ...
      },
      {
        field: "C12",
        headerName:
          "C.12 Which type of facility did you or the patient shifted?",
      ...
      },
      {
        field: "C13",
        headerName:
          "C.13 What was the name of the facility the patient shifted?",
      },
      {
        field: "C14",
        headerName:
...
const generateDColumns = (data, maxMembers) => {
  return Array.from({ length: maxMembers }, (_, index) => {
    const columns = [
      {
        field: "D1_0",
...
export const CSTColumns = (data) => {
  ...
  const emergencyColumns = generateColumns(maxMembers, MemberColumns);
  // const emergencyColumns = generateEmergencyColumns(data, maxMembers);
  const BColumns = generateBColumns(data, maxMembers);
