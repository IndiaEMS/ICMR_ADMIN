...
const columns = [
  ...
  // },
  {
    ...
    headerName: "GPS_1",
    valueGetter: (params) => params?.data?.LOTA9?.latitude ?? params?.data?.LOTA9?.lat,
  },
  {
    field: "LOTA9_longitude",
    headerName: "GPS_2",
    valueGetter: (params) => params?.data?.LOTA9?.longitude ?? params?.data?.LOTA9?.long,
  },
  {
  ...
  {
    headerName: "Acute Respiration Illness",
    children:
      [
        {
          field: "LOTF1",
  ...
  {
    headerName: "Post Partum Heamorrhage",
    children:
      [{
        field: "LOTH1",
        headerName: "Shifted to OT",
...
export const LOTFinalColumns = generateColumns(columns);
